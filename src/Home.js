                ...
                <div className="col-sm-6 col-md-4 col-lg-3 mt-4" style={{display: "inline-flex"}}>
                    <div className="card card-inverse card-info" style={{width:"300px"}} >
                        ...
                        <div className="card-footer p-1">
                            <div><button className="btn btn-info btn-sm">Follow</button>    </div>
                            <div><small className="float-right p-0 m-0">Creacion: {this.getTimeElpse(value.upload_at)}</small></div>
